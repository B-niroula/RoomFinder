...
import { Distribution, OriginAccessIdentity, CachePolicy, CacheHeaderBehavior, CacheQueryStringBehavior, CacheCookieBehavior } from "aws-cdk-lib/aws-cloudfront";
...
export class UiDeploymentStack extends Stack {
    ...
    constructor(scope: Construct, id: string, props?: StackProps) {
        ...
        const cachePolicy = new CachePolicy(this, 'SpaCachePolicy', {
            cachePolicyName: `SpaceFinder-Cache-${suffix}`,
            comment: 'Cache policy for SPA - no caching for HTML',
